...
class OpenSearchDocIndex(BaseDocIndex, Generic[TSchema]):
    ...
    def __init__(self, db_config=None, **kwargs):
        ...
        if len(self._db_config.index_settings):
            self._client_create(
                {'index': {'index.knn': True, **self._db_config.index_settings}}
            )
    ...
    class QueryBuilder(BaseDocIndex.QueryBuilder):
        ...
        def build(self, *args, **kwargs) -> Any:
            ...
            if len(self._query['query']) == 0:
                ...
                self._query['knn']['filter']['location'] = self._query['query']
                del self._query['query']
    ...
    class DBConfig(BaseDocIndex.DBConfig):
        ...
        hosts: Union[List[Union[str, Mapping[str, Union[str, int]]]], None] = field(
        ...
        def knn_vector_config(self):
            ...
            config = {
                'dimension': 128,
                'space_type': 'cosine',  # 'l2_norm', 'dot_product', 'cosine'
                'm': 16,
                'ef_construction': 100,
    ...
    def _client_create(self, settings: Dict[str, Any]):
        self._client.indices.create(index=self.index_name, body={'settings': settings})
