...
def test_index_simple_schema(
    ...
    index = OpenSearchDocIndex[SimpleDoc](index_name=tmp_index_name)
    if use_docarray:
...
def test_index_flat_schema(ten_flat_docs, use_docarray, tmp_index_name):  # noqa: F811
    index = OpenSearchDocIndex[FlatDoc](index_name=tmp_index_name)
    if use_docarray:
...
def test_index_nested_schema(
    ...
    index = OpenSearchDocIndex[NestedDoc](index_name=tmp_index_name)
    if use_docarray:
...
def test_index_deep_nested_schema(
    ...
    index = OpenSearchDocIndex[DeepNestedDoc](index_name=tmp_index_name)
    if use_docarray:
...
def test_get_single(ten_simple_docs, ten_flat_docs, ten_nested_docs):  # noqa: F811
    # simple
    index = OpenSearchDocIndex[SimpleDoc]()
    index.index(ten_simple_docs)
    ...
    # flat
    index = OpenSearchDocIndex[FlatDoc]()
    index.index(ten_flat_docs)
...
def test_persisting(ten_simple_docs, tmp_index_name):  # noqa: F811
    ...
    index2 = OpenSearchDocIndex[SimpleDoc](index_name=tmp_index_name)
...
def test_index_union_doc():  # noqa: F811
    ...
    index = OpenSearchDocIndex[MySchema]()
...
def test_index_multi_modal_doc():
    ...
    index = OpenSearchDocIndex[MyMultiModalDoc]()
